...
h1 = layers.Dense(200, activation="relu")(h0)
...
class VAE(keras.Model):
    ...
    def train_step(self, data):
        with tf.GradientTape() as tape:
            ...
            total_loss = reconstruction_loss + kl_loss + sign_loss*10 
...
sns.scatterplot(x=pca_res[:, 0], y=pca_res[:, 1], hue=scaled_methyl.iloc[:, gene_i_want], palette='coolwarm', ax = ax3)
plt.show()
...
#embedding_df.to_csv('/Users/smasarone/Documents/Omics_datasets_integration/methylation_emb_gene_norm.csv')
