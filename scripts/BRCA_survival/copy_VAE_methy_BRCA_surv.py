...
# this is the one sed in the notebook
...
sns.scatterplot(x=pca_res[:, 0], y=pca_res[:, 1], hue=scaled_methyl.loc[:,'TMEM101'], palette='coolwarm', ax = ax3)
...
#embedding_df.to_csv('/Users/smasarone/Documents/Omics_datasets_integration/BRCA_experiments/BRCA_embeddings/methy_BRCA_embedding_survival2.csv')
