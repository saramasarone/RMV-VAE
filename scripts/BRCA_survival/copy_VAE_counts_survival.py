...
sns.scatterplot(x=pca_res[:, 0], y=pca_res[:, 1], hue=scaled_counts.loc[:,'BRCA1|672'], palette='coolwarm', ax = ax3)
...
#embedding_df.to_csv("/Users/smasarone/Documents/Omics_datasets_integration/BRCA_experiments/BRCA_embeddings/counts_embedding_BRCA_survival2.csv")
